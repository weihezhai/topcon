...
if __name__ == "__main__":
    # Example usage
    predictions_path = "/mnt/parscratch/users/acr24wz/etu/topcon/qwen3_4B/finetuned_model/rl/individual_predictions.json"  # Update with your actual path
    ...
    save_results(results, "rl_4_subdomain_accuracy_results.json")
