...
class OpenReviewCrawlerWithPDFs:
    ...
    def get_conference_papers(self, limit: int = None, venue_year: str = '2024', conference: str = 'neurips') -> List[Dict]:
        ...
        if venue_year in conf_formats:
            possible_invitations = conf_formats[venue_year]
        else:
...
def main():
    ...
    parser.add_argument('--output-dir', '-o', type=str, default='/ceph/hpc/home/euweihez/topcon/d2025d08-005-users/iclr_2025/',
    ...
    parser.add_argument('--venue', type=str, default='2024',
                       choices=['2026', '2025','2024', '2023', '2022', '2021'], 
...
if __name__ == "__main__":
    ...
    # Crawl ICLR 2026 papers with PDFs
    python spider_with_pdfs_api2.py --conference iclr --venue 2026 --limit 0
    
    # Crawl 1000 NeurIPS 2024 papers with PDFs to custom directory
    python spider_with_pdfs_api2.py --output-dir /path/to/output --limit 1000 --conference neurips
    
    # Crawl ICLR 2024 papers without PDFs
    python spider_with_pdfs_api2.py --conference iclr --venue 2024 --no-pdfs --limit 500
    
    # Crawl ICML 2023 papers with PDFs
    python spider_with_pdfs_api2.py --conference icml --venue 2023 --limit 200
    
    # Crawl EMNLP 2024 papers
    python spider_with_pdfs_api2.py --conference emnlp --venue 2024
    
    # Test connection only
    python spider_with_pdfs_api2.py --test-connection
    
    # Crawl unlimited papers (all available)
    python spider_with_pdfs_api2.py --limit 0 --conference neurips
    """
    main()
