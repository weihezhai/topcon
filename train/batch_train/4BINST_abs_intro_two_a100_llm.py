...
def main():
    ...
    try:
        ...
        parser.add_argument("--output_dir", type=str, default="/mnt/parscratch/users/acr24wz/etu/topcon/qwen3_4B_instruct/finetuned/llm/checkpoint-600", help="Directory to save/load the fine-tuned model")
