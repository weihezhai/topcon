...
def main():
    ...
    try:
        ...
        parser.add_argument("--output_dir", type=str, default="/mnt/parscratch/users/acr24wz/etu/topcon/qwen3_4B/cpt_model/balanced/finetuned/th", help="Directory to save/load the fine-tuned model")
