...
def main():
    ...
    try:
        ...
        parser.add_argument("--data_folder", type=str, default="/mnt/parscratch/users/acr24wz/src/iclr/mineru/merged/llm/", help="Path to the folder containing training jsons")
        ...
        parser.add_argument("--output_dir", type=str, default="/mnt/parscratch/users/acr24wz/etu/topcon/qwen3_4B/non_cpt_model/imbalanced/finetuned/llm", help="Directory to save/load the fine-tuned model")
        ...
        PROCESSED_DATASET_CACHE = f"/mnt/parscratch/users/acr24wz/etu/topcon/processed_dataset/merged/{cache_suffix}"
