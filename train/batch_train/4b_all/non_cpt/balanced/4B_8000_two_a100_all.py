...
def main():
    ...
    try:
        ...
        parser.add_argument("--output_dir", type=str, default="/mnt/parscratch/users/acr24wz/etu/topcon/qwen3_4B/non_cpt_model/balanced/finetuned/all", help="Directory to save/load the fine-tuned model")
