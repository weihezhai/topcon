...
def main():
    ...
    try:
        ...
        parser.add_argument("--data_folder", type=str, default="/mnt/parscratch/users/acr24wz/src/iclr/mineru/rl/", help="Path to the folder containing training jsons")
        parser.add_argument("--labels_file", type=str, default="/mnt/parscratch/users/acr24wz/public/balanced_labels.json", help="Path to the file containing labels")
        ...
        parser.add_argument("--output_dir", type=str, default="/mnt/parscratch/users/acr24wz/etu/topcon/qwen3_8B/cpt_model/imbalanced/finetuned/rl", help="Directory to save/load the fine-tuned model")
