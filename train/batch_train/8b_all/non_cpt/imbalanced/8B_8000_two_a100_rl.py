...
def main():
    ...
    try:
        ...
        parser.add_argument("--output_dir", type=str, default="/mnt/parscratch/users/acr24wz/etu/topcon/qwen3_8B/non_cpt_model/imbalanced/finetuned/rl", help="Directory to save/load the fine-tuned model")
