...
def main():
    ...
    ap.add_argument("--output_dir", type=str, default="/mnt/parscratch/users/acr24wz/etu/topcon/qwen3_4B/cpt_model")
    ap.add_argument("--block_size", type=int, default=4096, help="Pack tokens to this length; pick what fits memory (e.g., 2048/4096/8192)")
    ...
    ap.add_argument("--cache_dir", type=str, default="/mnt/parscratch/users/acr24wz/etu/topcon/processed_dataset", help="Directory to store cached datasets")
    ap.add_argument("--model_cache_dir", type=str, default="/mnt/parscratch/users/acr24wz/etu/topcon/models", help="Directory to store cached models")
