...
#SBATCH --job-name=cpt_qwen3_8b
#SBATCH --output=./logs/cpt_qwen3_8b.%j.out
...
# Run continued pretraining with 8B model
python cpt_gpt.py \
    ...
    --output_dir "/mnt/parscratch/users/acr24wz/etu/topcon/qwen3_8B/cpt_model" \
    --block_size 2048 \
    --max_length 10000 \
    --epochs 2 \
    --lr 8e-6 \
...
echo "Continued pretraining with 8B model completed!"
