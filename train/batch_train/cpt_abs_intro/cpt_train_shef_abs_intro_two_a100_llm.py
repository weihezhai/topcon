...
def main():
    ...
    try:
        ...
        parser.add_argument("--output_dir", type=str, default="/mnt/parscratch/users/acr24wz/etu/topcon/qwen3_4B/cpt/finetuned", help="Directory to save/load the fine-tuned model")
        ...
        # Model directories
        BASE_MODEL_CACHE = "/mnt/parscratch/users/acr24wz/etu/topcon/qwen3_4B/cpt/checkpoint-4000"  # Where to cache the downloaded model
