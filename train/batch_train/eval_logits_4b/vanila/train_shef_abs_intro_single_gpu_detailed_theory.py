...
def batched_accuracy_evaluation(trainer, eval_dataset, batch_size=10, detailed_eval=False, tokenizer=None, save_predictions=False, output_dir=None):
    ...
    if save_predictions and output_dir:
        predictions_file = os.path.join(output_dir, "theory_individual_predictions.json")
...
def main():
    ...
    try:
        ...
        parser.add_argument("--output_dir", type=str, default="/mnt/parscratch/users/acr24wz/etu/topcon/qwen3_4B/", help="Directory to save/load the fine-tuned model")
