...
def main():
    ...
    log_file = os.path.join(log_dir, f"training_log_all_single_gpu_{timestamp}.log")
    ...
    try:
        ...
        parser.add_argument("--data_folder", type=str, default="/mnt/parscratch/users/acr24wz/src/iclr/data/scratch/mpx602/topcon-1/conference_data/iclr_2025_data/all_four_domain/four_domain_text", help="Path to the folder containing training data")
        ...
        parser.add_argument("--output_dir", type=str, default="/mnt/parscratch/users/acr24wz/etu/topcon/qwen3_1d7B/finetuned_model/all_four_domain", help="Directory to save/load the fine-tuned model")
        ...
        PROCESSED_DATASET_CACHE = "/mnt/parscratch/users/acr24wz/etu/topcon/processed_dataset/all_four_domain"
