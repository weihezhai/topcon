...
def main():
    ...
    log_file = os.path.join(log_dir, f"training_log_rl_4B_{timestamp}.log")
    ...
    try:
        ...
        parser.add_argument("--output_dir", type=str, default="/mnt/parscratch/users/acr24wz/etu/topcon/qwen3_4B/finetuned_model/rl", help="Directory to save/load the fine-tuned model")
