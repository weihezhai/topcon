...
def parse_args():
    ...
    p.add_argument(
        "--model_path",
        default="/mnt/parscratch/users/acr24wz/etu/topcon/qwen3_4B/cpt_model/balanced/finetuned/all/checkpoint-1800/",
    ...
    p.add_argument(
        ...
        default="/mnt/parscratch/users/acr24wz/etu/topcon/processed_dataset/balanced/all_mineru_all",
