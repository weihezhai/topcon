...
# Configuration
DATA_FOLDER = "/mnt/parscratch/users/acr24wz/src/iclr/data/scratch/mpx602/topcon-1/conference_data/iclr_2025_data/filtered_cv_papers/cv_papers_text/"  # Adjust path as needed
LABELS_FILE = "/mnt/parscratch/users/acr24wz/topcon/train/label_simple.json"  # Adjust path as needed
EVAL_MAPPING_FILE = "/mnt/parscratch/users/acr24wz/etu/topcon/processed_dataset/cv/cv_index_to_paper_id_mapping.json"
