...
def main():
    ...
    try:
        ...
        parser.add_argument("--output_dir", type=str, default="/mnt/parscratch/users/acr24wz/etu/topcon/Llama-3.2-1B/finetuned_model/theory", help="Directory to save/load the fine-tuned model")
