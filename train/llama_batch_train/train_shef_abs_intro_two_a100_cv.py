...
def main():
    ...
    log_file = os.path.join(log_dir, f"training_log_cv_{timestamp}.log")
    ...
    try:
        ...
        parser.add_argument("--output_dir", type=str, default="/mnt/parscratch/users/acr24wz/etu/topcon/Llama-3.2-3B-Instruct/finetuned_model/cv", help="Directory to save/load the fine-tuned model")
