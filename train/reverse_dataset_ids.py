...
def main():
    ...
    cache_dir = "/mnt/parscratch/users/acr24wz/etu/topcon/processed_dataset/llm"
    output_dir = '/mnt/parscratch/users/acr24wz/etu/topcon/processed_dataset/llm/with_ids'
