...
def main():
    ...
    cache_dir = "/mnt/parscratch/users/acr24wz/etu/topcon/processed_dataset/cv"
    output_dir = '/mnt/parscratch/users/acr24wz/etu/topcon/processed_dataset/cv/with_ids'
