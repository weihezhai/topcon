...
# Launch evaluation with accelerate
accelerate launch \
    --config_file /data/scratch/mpx602/topcon-1/train/subs/deepseek/accelerate_config.yaml \
    /data/scratch/mpx602/topcon-1/train/subs/deepseek/train_shef_abs_intro.py \
    --eval \
    --detailed_eval \
