...
def main():
    ...
    try:
        ...
        parser.add_argument("--data_folder", type=str, default="/mnt/parscratch/users/lip22fh/ACL2026_paper_predict/balanced_dataset/balanced_datasets/balanced_all", help="Path to the folder containing training jsons")
        ...
        parser.add_argument("--output_dir", type=str, default="/mnt/parscratch/users/lip22fh/ACL2026_paper_predict/models/qwen3_4b/cpt/vl/wl/all/", help="Directory to save/load the fine-tuned model")
